...
class RegisterCustomerForm(forms.Form):
    ...
    def create_customer(self):
        ...
        user.save()
        account = CustomerAccount(user=user,
...
class LoginForm(forms.Form):
    ...
    def is_valid(self):  # doesn't render errors
        """Checks for valid user and returns it if authentication is
        successful"""
