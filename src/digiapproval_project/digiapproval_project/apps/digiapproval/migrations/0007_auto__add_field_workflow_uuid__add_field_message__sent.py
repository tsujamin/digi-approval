...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workflow.uuid'
        db.add_column(u'digiapproval_workflow', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='479988cef7f04b10a64c63df13d055da', max_length=36),
                      keep_default=False)

        # Adding field 'Message._sent'
        db.add_column(u'digiapproval_message', '_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workflow.uuid'
        db.delete_column(u'digiapproval_workflow', 'uuid')

        # Deleting field 'Message._sent'
        db.delete_column(u'digiapproval_message', '_sent')
    ...
    models = {
        ...
        u'digiapproval.workflow': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1dca3d4dc47345d282b23458b5637f04'", 'max_length': '36'}),
