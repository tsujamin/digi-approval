...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workflow.parent_workflow'
        db.add_column(u'digiapproval_workflow', 'parent_workflow',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='subworkflows', null=True, blank=True, to=orm['digiapproval.Workflow']),
                      keep_default=False)

        # Adding field 'Workflow.parent_task'
        db.add_column(u'digiapproval_workflow', 'parent_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='subworkflows', null=True, blank=True, to=orm['digiapproval.Task']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workflow.parent_workflow'
        db.delete_column(u'digiapproval_workflow', 'parent_workflow_id')

        # Deleting field 'Workflow.parent_task'
        db.delete_column(u'digiapproval_workflow', 'parent_task_id')
    ...
    models = {
        ...
        u'digiapproval.workflow': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'befdacc097a8466da21f0d9d73aa3530'", 'max_length': '36'}),
