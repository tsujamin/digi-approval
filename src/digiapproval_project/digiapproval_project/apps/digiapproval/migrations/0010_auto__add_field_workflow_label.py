...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workflow.label'
        db.add_column(u'digiapproval_workflow', 'label',
                      self.gf('django.db.models.fields.CharField')(default='Untitled Application', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workflow.label'
        db.delete_column(u'digiapproval_workflow', 'label')
    ...
    models = {
        ...
        u'digiapproval.workflow': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6a520efcd2474f11a7916f1a397780c5'", 'max_length': '36'}),
