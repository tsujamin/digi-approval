...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkflowSpec.description'
        db.add_column(u'digiapproval_workflowspec', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'WorkflowSpec.delegators'
        db.add_column(u'digiapproval_workflowspec', 'delegators',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='workflowspecs_delegators', null=True, blank=True, to=orm['auth.Group']),
                      keep_default=False)

        # Adding field 'WorkflowSpec.approvers'
        db.add_column(u'digiapproval_workflowspec', 'approvers',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='workflowspecs_approvers', null=True, blank=True, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkflowSpec.description'
        db.delete_column(u'digiapproval_workflowspec', 'description')

        # Deleting field 'WorkflowSpec.delegators'
        db.delete_column(u'digiapproval_workflowspec', 'delegators_id')

        # Deleting field 'WorkflowSpec.approvers'
        db.delete_column(u'digiapproval_workflowspec', 'approvers_id')
