...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'digiapproval_task', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='badbad-badb-adba-dbad-badbadbadbadba', max_length='36'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.uuid'
        db.delete_column(u'digiapproval_task', 'uuid')
