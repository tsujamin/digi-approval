...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workflow.state'
        db.add_column(u'digiapproval_workflow', 'state',
                      self.gf('django.db.models.fields.CharField')(default='STARTED', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workflow.state'
        db.delete_column(u'digiapproval_workflow', 'state')
    ...
    models = {
        ...
        u'digiapproval.workflow': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3b2c0dbfe9504958ab05f9dccc1f4af3'", 'max_length': '36'}),
